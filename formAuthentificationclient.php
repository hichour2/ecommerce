...
<?php
	...
	if(isset($_SESSION['clientLogin']) and isset($_SESSION['clientMotPasse'])){
		unset($_SESSION['clientLogin']);
		unset($_SESSION['clientMotPasse']);
	...
	echo '</td></tr><tr><td>';
?>
<form id="form1" name="form1" method="post" action="authentificationclient.php">
  <table width="356" border="0" align="center">
    <tr>
      <td colspan="3" align="center"><h2><font color="#CC0033">Authentification Client : </font></h2></td>
    </tr>
    <tr>
