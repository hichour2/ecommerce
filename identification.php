...
<?php
	...
	function verifier ($login, $motPasse){
		...
		$res = mysql_query("select * from administrateur where login like '$login' and pass like '$motPasse'");
			//echo ("select * from adherent where login like '$login'");
			//echo $res;
				if(mysql_num_rows($res)==0)
				return "Vous n'etes pas administrateur de cette application !!!!";
		}
		return "true";
	}
	...
	if(strcmp($msg, "true") != 0){
		echo $msg;
		echo "<br/>Cliquer <a href=\"formidentification.php\">ici</a> pour revenir au formulaire....";
	}
	else {
		$_SESSION['admin'] = true;
		echo "<br/>Bienvenu:<font color='orange'>".$login."</font>";
